                    ...
                    <div className="grid-container">
                        <div className="rounded-3xl w-full sm:h-[326px] h-fit flex justify-center items-center">
                            <Globe
                                ...
                                labelsData={[{ lat: 31.1471, lng: 75.3412, text: "I'm here", color: 'white', size: 15 }]}
                            />
                        </div>
                        <div>
                ...
                <div className="xl:col-span-2 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">
                                I love solving problems and building things through code. Programming isn't just my profession—it's my passion. I enjoy exploring new technologies and enhancing my skills, with a strong proficiency in Java, as well as knowledge of C++ and C.
                            </p>
                        </div>
                    </div>
                </div>
